...
def app():
    ...
    # Sample image
    st.markdown('<div class="card"><p style="font-family:sans-serif; color:black; font-size: 20px;">Sample image 👇</p></div>', unsafe_allow_html=True)
    sample_img = "30.jpg"
    st.image(
        sample_img,
        caption="This is a sample image which you feed in this app and calculate the intensity :)",
        ...
        with col1:
            ...
            if st.button('Compute Intensity'):
                with col2:
                    ...
                    st.markdown(f'<div class="card" style="margin-top:70px;"><p style="font-family:sans-serif; color:black;">The intensity of Cyclone is {str(intensity[0][0])} KNOTS </p></div>', unsafe_allow_html=True)
                    st.markdown(f'<div class="card" style="margin-top:50px;"><p style="font-family:sans-serif; color:black;">The Cyclone is heading towards {directions[direction_index]}</p></div>', unsafe_allow_html=True)
